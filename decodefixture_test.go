...
// FITACTIVITY_REAL_FIT and therefore asserts nothing for anyone but its author.
//
...
// Garmin actually writes. See fitactivity/fittest's package comment.
//
// fitactivity/fittest does not import the fitactivity package, so using it from inside
