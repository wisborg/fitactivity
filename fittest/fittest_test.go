...
//
// It deliberately does not import the fitactivity package: that package is one of
...
// library rather than the fitactivity package: that package is one of the things
...
// mirroring how fitactivity.Decode drives it.
